...
class UserController extends Controller
{
     ...
     * summary="User Login",
      *   description="Login user<br/>
        Success Code:<br/>
            6502: User login successfully.<br/>
        Error Code:<br/>
    ...
    public function loginAccount(Request $request) 
    {
        ...
        return ResponseUtility::respondWithSuccess(4502, array('session_token' => $userData['session_token'], 'user_data' => $userData['user_data']['data']));
    }
